...
const gradients = [
  'from-brand-600/15 to-brand-600/5',
  'from-emerald-600/15 to-emerald-600/5',
  'from-amber-600/15 to-amber-600/5',
  'from-blue-600/15 to-blue-600/5',
  'from-pink-600/15 to-pink-600/5',
  'from-violet-600/15 to-violet-600/5',
]
const borderColors = [
          ...
          {keys.map((key, i) => {
            ...
            return (
              <div key={key}
                ...
                <div className="mt-4 flex items-center gap-1.5 text-xs text-slate-300 group-hover:text-slate-400 transition-colors">
